...
type PowS = forall a . (Eq a, Fractional a, Num (PowS' a), Fractional (PowS' a)) => PowS' a
type PowS2 = forall a . (Eq a, Fractional a, Num (PowS' a), Fractional (PowS' a)) => PowS' (PowS' a)
